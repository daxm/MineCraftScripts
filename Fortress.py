...
################
# The goal of this script is to create a massive fortress that towers 256 blocks up, 256 blocks on a side,
# and steps down with the interior being leveled at a height of 64 blocks.
